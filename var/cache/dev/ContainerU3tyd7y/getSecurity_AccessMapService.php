...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/S/'), [0 => 'ROLE_STUDENT'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/T/'), [0 => 'ROLE_TEACHER'], NULL);
