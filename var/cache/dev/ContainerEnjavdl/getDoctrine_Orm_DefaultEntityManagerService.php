...
$b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\ElitBundle\\Entity')]), 'ElitBundle\\Entity');
...
$a->setEntityNamespaces(['ElitBundle' => 'ElitBundle\\Entity']);
